"""Detection models and aggregate reporting for Move language static analysis."""
...
@dataclass
class Detection:
    """Individual pattern detection or hazard finding in Move."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "module", "struct", "resource", "fn", "entry", "spec", "constant"
    ...
    def summary(self) -> str:
        ...
        return f"Move architectural pattern: {self.pattern_type.value}"
...
class DetectionReport:
    """Aggregate scan result containing all detections across a Move project."""
