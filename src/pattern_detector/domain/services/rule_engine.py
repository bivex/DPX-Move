"""Domain service evaluating pattern detection rules on Move CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a Move CodeModel with confidence thresholding and filtering."""
