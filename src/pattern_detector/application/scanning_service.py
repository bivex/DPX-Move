"""Application scanning service orchestrating Move pattern detection."""
...
class ScanningService(ScannerPort):
    """Coordinates discovering, parsing, rule evaluation, and exporting for Move smart contracts."""
